...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Rskriskcontrol.findAll", query = "SELECT r FROM Rskriskcontrol r")
    , @NamedQuery(name = "Rskriskcontrol.findByRcid", query = "SELECT r FROM Rskriskcontrol r WHERE r.rskriskcontrolPK.rcid = :rcid")
    , @NamedQuery(name = "Rskriskcontrol.findByRcvslcode", query = "SELECT r FROM Rskriskcontrol r WHERE r.rskriskcontrolPK.rcvslcode = :rcvslcode")
    , @NamedQuery(name = "Rskriskcontrol.findByControltype", query = "SELECT r FROM Rskriskcontrol r WHERE r.controltype = :controltype")
    , @NamedQuery(name = "Rskriskcontrol.findByControlmeasure", query = "SELECT r FROM Rskriskcontrol r WHERE r.controlmeasure = :controlmeasure")
    , @NamedQuery(name = "Rskriskcontrol.findByFrequency", query = "SELECT r FROM Rskriskcontrol r WHERE r.frequency = :frequency")
    , @NamedQuery(name = "Rskriskcontrol.findByConsequence", query = "SELECT r FROM Rskriskcontrol r WHERE r.consequence = :consequence")
    , @NamedQuery(name = "Rskriskcontrol.findByRisklevel", query = "SELECT r FROM Rskriskcontrol r WHERE r.risklevel = :risklevel")})
public class Rskriskcontrol implements Serializable {
	...
	@JoinColumns({ @JoinColumn(name = "hazardno", referencedColumnName = "hazardno"), @JoinColumn(name = "id", referencedColumnName = "id"), @JoinColumn(name = "vslcode", referencedColumnName = "vslcode") })
	@ManyToOne(optional = false)
